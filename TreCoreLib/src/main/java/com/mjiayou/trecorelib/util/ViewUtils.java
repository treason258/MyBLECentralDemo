    ...
    public static void printMotionEvent(MotionEvent event, String viewStr, String method) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                LogUtils.i(TAG, viewStr + " | " + method + " | action ACTION_DOWN");
                break;
            case MotionEvent.ACTION_UP:
                LogUtils.i(TAG, viewStr + " | " + method + " | action ACTION_UP");
                break;
            case MotionEvent.ACTION_MOVE:
                LogUtils.i(TAG, viewStr + " | " + method + " | action ACTION_MOVE");
                break;
            case MotionEvent.ACTION_CANCEL:
                LogUtils.i(TAG, viewStr + " | " + method + " | action ACTION_CANCEL");
                break;
            default:
                LogUtils.i(TAG, viewStr + " | " + method + " | action " + event.getAction());
                break;
        }
    }
