...
public class DirectoryUtil {
    ...
    private DirectoryUtil() {
        Context context = TCHelper.mContext;
        ...
        try {
            SYSTEM_APP_EXTERNAL_CACHE = context.getExternalCacheDir().getPath() + "/"; // /storage/emulated/0/Android/data/cn.soccerapp.soccer/cache/
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            SYSTEM_APP_EXTERNAL_FILES_DOWNLOADS = context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getPath() + "/"; // /storage/emulated/0/Android/data/cn.soccerapp.soccer/files/Download
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            SYSTEM_APP_EXTERNAL_FILES_DCIM = context.getExternalFilesDir(Environment.DIRECTORY_DCIM).getPath() + "/";  // /storage/emulated/0/Android/data/cn.soccerapp.soccer/files/DCIM
        } catch (Exception e) {
            e.printStackTrace();
         ...
         * APP根目录
         */
        APP_ROOT = SDCARD_ROOT + TCHelper.mAppName + "/"; // /storage/emulated/0/trecorelib/
        /**
         * APP 常用目录
         */
    ...
    public String getDirectoryInfo() {
        ...
        builder.append("\n");
        builder.append("APP_NAME（应用名称） = ").append(TCHelper.mAppName).append("\n");
